...
class Ques11ViewController: UIViewController {
    ...
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
        quesList.ques11_1 = label1.text ?? ""
        quesList.ques11_2 = label2.text ?? ""
        quesList.ques11_3 = label3.text ?? ""
        quesList.ques11_4 = label4.text ?? ""
        quesList.ques11_5 = label5.text ?? ""
        
        if quesList.ques11_1.isEmpty || quesList.ques11_2.isEmpty || quesList.ques11_3.isEmpty || quesList.ques11_4.isEmpty || quesList.ques11_5.isEmpty {
